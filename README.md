...
- **Билды** (`/builds`, `/builds/:id`) — список карточек: заголовок (иконка+название, клик → карточка билда), под ним — кликабельные спрайты предметов, и раздел «Возможно связано с» (кликабельные иконки других билдов). Поиск/фильтр по тегу/сортировка/кнопка «Предложить билды» (автокластеризация)/«+ Создать билд». `/builds/:id` — форма редактирования (имя/иконка/описание/состав/**ручные связи с другими билдами**).
