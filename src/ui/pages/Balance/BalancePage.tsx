            ...
            <DialogContent>
                <Stack spacing={2} sx={{ pb: 1 }}>
                    ...
                    <Typography variant="body2">
                        ...
                        его <b>скейлеров</b>: предметов, с которыми у этого предмета есть прямая связь (ступень
                        ровно 1 в его собственном графе — участники билда, где этот предмет является корнем, и
                        связаны с ним напрямую; более глубокие, косвенные скейлеры не учитываются). Для каждого
                        такого скейлера отдельно считается его собственная вероятность появления в магазине (раздел
