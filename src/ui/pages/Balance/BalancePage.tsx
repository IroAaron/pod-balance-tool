            ...
            <DialogContent>
                <Stack spacing={2} sx={{ pb: 1 }}>
                    ...
                    <Typography variant="body2">
                        ...
                        «Константах»). S — не отдельный множитель в формуле, а источник данных для M и Σ(Q×V): оба
                        считаются только по билдам из S. <b>M</b> — количество уникальных предметов, с которыми у
                        исследуемого предмета есть прямая связь (в обе стороны — и то, что он сам скейлит, и то,
