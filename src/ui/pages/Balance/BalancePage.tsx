        ...
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            ...
            <DialogContent>
                <Stack spacing={2} sx={{ pb: 1 }}>
                    ...
                    <Typography variant="body2">
                        <b>P считается автоматически</b> из раздела «Магазин» (таблицы Паки/Колоды): визит в
                        магазин показывает 3 случайных пака (сам список паков/весов между ними не экспортируется
                        ни в одной таблице, поэтому пул паков считается равновероятным); внутри выбранного пака
                        шанс конкретного предмета зависит от его веса в колоде и числа розыгрышей пака. P — это
                        вероятность, что предмет попадётся хотя бы раз среди этих 3 паков. Если для предмета нет
                        данных (не встречается ни в одной магазинной колоде), используется запасное значение P из
                        «Констант».
                    </Typography>
                </Stack>
            </DialogContent>
